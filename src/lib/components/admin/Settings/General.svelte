						...
						<div class="flex w-full justify-between items-center">
							<div class="flex flex-col text-xs text-gray-700 dark:text-gray-200">
								<div class="flex gap-1">
									...
									<a
										href="https://github.com/aria/aria/releases/tag/v{version.latest}"
										target="_blank"
									>
										{updateAvailable === null
					...
					<div class="mb-2.5">
						<div class="flex w-full justify-between items-center">
							<div class="text-xs pr-2">
								...
								<div class=" text-xs text-gray-500">
									{$i18n.t('Discover how to use arIA and seek support from the community.')}
								</div>
							</div>
						...
						<div class="mt-1">
							<div class="flex space-x-1">
								...
								<a href="https://twitter.com/arIA" target="_blank">
									<img
										alt="X (formerly Twitter) Follow"
										src="https://img.shields.io/twitter/follow/arIA"
									/>
								</a>

								<a href="https://github.com/aria/aria" target="_blank">
									<img
										alt="Github Repo"
										src="https://img.shields.io/github/stars/aria/aria?style=social&label=Star us on Github"
									/>
								</a>
							</div>
						</div>
						...
						{#if adminConfig?.ENABLE_API_KEY_ENDPOINT_RESTRICTIONS}
							<div class=" flex w-full flex-col pr-2">
								...
								<div class="mt-2 text-xs text-gray-400 dark:text-gray-500">
									<!-- https://docs.aria.com/getting-started/advanced-topics/api-endpoints -->
									<a
										href="https://docs.aria.com/getting-started/api-endpoints"
										target="_blank"
